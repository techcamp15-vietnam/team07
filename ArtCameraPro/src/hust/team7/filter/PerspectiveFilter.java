...
public class PerspectiveFilter extends TransformFilter {
	 ...
	 *            the new position of the top right corner
	 * @param x2
	 *            the new position of the bottom right corner
	 * @param y2
	 *            the new position of the bottom right corner
	 * @param x3
	 ...
	 * 
	 * @param x0
	 *            the old position of the top left corner
	 * @param y0
	 *            the old position of the top left corner
	 * @param x1
	 *            the old position of the top right corner
	 * @param y1
	 *            the old position of the top right corner
	 * @param x2
	 *            the old position of the bottom right corner
	 * @param y2
	 *            the old position of the bottom right corner
	 * @param x3
	...
	protected void transformSpace(Rect rect) {
		if (scaled) {
			...
			rect.right = (int) Math.max(Math.max(x0, x1), Math.max(x2, x3))
					- rect.left;
			rect.bottom = (int) Math.max(Math.max(y0, y1), Math.max(y2, y3))
					- rect.top;
			return;
		}
		if (!clip) {
	...
	protected void transformInverse(int x, int y, float[] out) {
		out[0] = originalSpace.right * (A * x + B * y + C)
				/ (G * x + H * y + I);
		out[1] = originalSpace.bottom * (D * x + E * y + F)
				/ (G * x + H * y + I);
	}
