package hust.team7.filter.util;
...
public class PixelUtils {
	...
	public static void getRGB(int[] src, int x, int y, int w, int h,
			int scanWidth, int[] pixel) {
		int pixelIndex = 0;
	...
	public static void setRGB(int[] dst, int x, int y, int w, int h,
			int scanWidth, int[] pixel) {
		int pixelIndex = 0;
		for (int yi = y; yi < y + h; yi++) {
			for (int xi = x; xi < x + w; xi++) {
